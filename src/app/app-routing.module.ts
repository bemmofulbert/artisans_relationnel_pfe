...
const routes: Routes =[
  ...
  {path: 'artisans/:metier_nom',component: PresentArtisansComponent},
  {path: 'list/artisan/',component: PresentArtisansComponent},
  {path: 'creer-offre' ,component: CreerOffreComponent},
  {path: 'creer-offre/:numSelected' ,component: CreerOffreComponent},
