...
import { Route,MouseRouteListenner } from './Route.js'
...
export class MapComponent{
  ...
  basemapsSelectElement = document.getElementById("basemaps");
  ...
  constructor() {
    ...
    this.searchArea = new VectorLayer();
  
    
    //---------------------Routes
    this.route  = new Route(map) 
    MouseRouteListenner(map,this.route)
    
    setBasemap(document.getElementById("basemaps").value);  
    
    this.basemapsSelectElement.addEventListener("change", (e) => {
